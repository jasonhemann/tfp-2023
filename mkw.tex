...
case, we invoke \rackinline|s∞|. Rather than a building largely
...
We assume it is agreed that our disjunction and conjunction themselves
are sufficiently high-level operators for a surface language and that
the zero-element base cases are at best unnecessary and likely
undesireable.
...
We have not fully
obviated the use of macros. While neither
...
few. We hope this document helps narrow the gap between
implementations in functional host languages with and without macro
systems and helps implementers build more elegant, expressive and

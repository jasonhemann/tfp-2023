...
definitions as follows. We start with the definition of the function
...
the call to \rackinline|apply| and making \rackinline|D| recur into
itself.

\noindent We combine \rackinline|g| and \rackinline|s| in each clause; this
suggests constructing that stream in \rackinline|disj| and passing it
along. The result of this final change is the definition

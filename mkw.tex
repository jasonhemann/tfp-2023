...
case, we invoke \rackinline|(s∞)| as a function of no arguments.
Rather than a building largely redundant implementation of
\rackinline|condu|, we expose the higher-order goal \rackinline|once|
to the user. The definition in \cref{mnt:condu-reimplementation} is
taken directly from \citetitle{friedman2018reasoned}. The programmer
can simulate \rackinline|condu| by wrapping \rackinline|once| around
every test goal.

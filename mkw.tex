...
either empty, non-empty, or a function of no arguments. Rather than
repeating this exercise for \rackinline|condu|, we expose the
higher-order goal \rackinline|once| to the user. The definition in
\cref{mnt:condu-reimplementation} is taken directly from
\citetitle{friedman2018reasoned}. The programmer can simulate

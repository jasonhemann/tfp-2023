...
%% THIS 1-or-more arguments model seems ideal, even for conda/condu?
...
%% Have we ever stated that one of our unwritten goals is to minimize
%% the number of closures we build.  And did we give an argument for
%% for why we would have that as a desiderata.
...
equational reasoning. \Cref{mnt:conj-right-fold-definition} shows a

...
We have not completely obviated the use of macros. Our microKanren
implementations, still use macros to implement \rackinline|defrel| and
...
time. Languages without expressive macro systems still have to resort
to exposing implementations of streams and \emph{some} lower level
operations like introducing variables one at a time.

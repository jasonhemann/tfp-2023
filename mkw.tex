...
\section{\rackinline{disj} and \rackinline{conj} goal
...
function that makes no use of variadic functions. Our focus will be on
recurring over the list \rackinline{gs}. Unlike \rackinline{D}, the
...
always yield a result. The equivalent right-fold implementation needs

\documentclass[runningheads,natbib=false]{llncs}
%% ∞
%% ⊂
%% …
%% ₀
...
%% ₃
%% ₁₂₃₄₅₆
\usepackage{fontspec,newunicodechar,textgreek}
...
\author{Jason Hemann\inst{1}\orcidID{0000-0002-5405-2936} \and
Daniel P. Friedman\inst{2}\orcidID{0000-0001-9992-1675}}

\title{Nearly Macro-free microKanren}

%
\authorrunning{Hemann \& Friedman}
% First names are abbreviated in the running head.
% If there are more than two authors, 'et al.' is used.
%
\institute{Seton Hall University, South Orange, NJ 07079, USA
\email{jason.hemann@shu.edu} \and
...
\rackinline{disj} produces and consumes goals, we can \texteta{}-expand that
...
\begin{minted}[autogobble,stripall,escapeinside=!!]{racket}
(define (disj g . g*)
  (cond
    ((null? g*) g)
...
\rackinline{conj₂} and β-reduce. We once again \texteta{}-expand the call to
...
%     ((null? g*) (g s))
%     (else ((conj₂ g (apply conj g*)) s))))
% =  { !\text{by definition of conj₂ and β-reduction}! }
% (define (C g g* s)
%   (cond
%     ((null? g*) (g s))
%     (else
...
%         (apply conj g*)
%         (g s)))))
% = { !\text{η-expand to use the definition of conj}! }
% (define (C g g* s)
%   (cond
%     ((null? g*) (g s))
%     (else
...
%      ((ifte g (car g*) (apply conda (cdr g*)))
%       s))))
% = { !\text{let bindings and eta-expansion}! }
% (define (A g g* s)
%   (cond
%     ((null? g*) (g s))
%     (else
...
%                ((apply conda g*) s)))
%            s)))))))
% = { !\text{by definition of conda, conj, and C}! }
% (define (A g g* s)
%   (cond
%     ((null? g*) (g s))
%     (else
...
%                (A (car g*) (cdr g*) s)))
%            s)))))))
% = { !\text{by definition of ifte and a β reduction}! }
% (define (A g g* s)
%   (cond
%     ((null? g*) (g s))
%     (else
...
% \begin{minted}[autogobble,stripall,escapeinside=!!y]{racket}
% (define (A g* s∞)
%   (cond
%     ((null? g*) s∞)
%     (else
